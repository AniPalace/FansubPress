<?php
class FansubPress_Recent_Posts extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'fansubpress_rp', // Base ID
			__('FansubPress Recent Posts'), // Name
			array( 'description' => __( 'Új leöltések és hírek megjelenítése' ), ) // Args
		);
	}
...
add_action( 'widgets_init', 'register_fansubpress_widget' );
function register_fansubpress_widget() {
    register_widget( 'FansubPress_Recent_Posts' );
}
