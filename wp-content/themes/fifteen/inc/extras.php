 ...
 */
function fifteen_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'fifteen_page_menu_args' );
 ...
 */
function fifteen_enhanced_image_navigation( $url, $id ) {
...
add_filter( 'attachment_link', 'fifteen_enhanced_image_navigation', 10, 2 );
